                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="purchase_no" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" id="purchase-no" title="Select purchase ref number...">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive mt-3">
                                                <table id="myTable" class="table table-hover purchase-list">
                                                    <thead>
                                                        <tr>
...
$('select[name="purchase_no"]').on('change', function() {
    var purchaseId = $(this).val();
    materialProductSearch(purchaseId)
});


// for show data in select products
...
function materialProductSearch(id){
    $.ajax({
        type: 'GET',
        url: 'search_material_product',
        data: {
            'id': id
        },
        success: function(data){
            data.forEach(product => {
                ...
                if(product.batch_no == null || product.batch_no == ''){
                    cols += '<td></td>';
                }else{
                    cols += '<td>' + product.batch_no + '</td>';
                }
                cols += '<td>' + product.remaining_qty + '</td>';
                cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger">{{trans("file.delete")}}</button></td>';
                newRow.append(cols);
                $("table.purchase-list tbody").prepend(newRow);
            });
        },
        error: function() {
            console.log(error);
